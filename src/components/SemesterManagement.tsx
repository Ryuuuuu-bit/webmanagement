          ...
          editingId === s.id ? (
            ...
            <div key={s.id} className="flex flex-wrap items-center justify-between gap-2 border-t border-line-soft pt-2 text-sm first:border-t-0 first:pt-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <button disabled={pending} onClick={() => onDelete(s.id, s.name)} className="rounded px-1.5 py-1.5 text-xs font-semibold text-danger disabled:opacity-40 hover:bg-line-soft">{dict.common.delete}</button>
              </div>
